...
btnRegistro.addEventListener("click", function() {
    ...
    fetch("http://tpaierg.orgfree.com/registro.php" ,{
        method: 'POST',
        body: datos
    })
...
ingresar.addEventListener("click",function(){
    ...
    fetch("http://tpaierg.orgfree.com/ingreso.php",{
        method: 'POST',
        body: datos
    })
...
enviarMen.addEventListener("click", function(){
    if(correoM.value ==""){
    ...
    fetch("http://tpaierg.orgfree.com/registrarMensaje.php",{
        method: 'POST',
        body: datos
    })
    .then(function(response){
...
function leerM(){
    ...
    fetch("http://tpaierg.orgfree.com/leerMensajes.php",{
        method: 'POST',
        body: datosLM
    })
